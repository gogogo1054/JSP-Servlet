...
public class NaverSearchServlet extends HttpServlet 
{
	...
	{
		String clientId = "QdMr52UuEP5avAYShcmY"; // 어플리케이션 클라이언트 아이디값
		String clientSecret = "o_Wd3GDzZB"; // 어플리케이션 클라이언트 시크릿값
...
//		String apiURL = "https://oepnapi.naver.com/v1/search/blog?query=" + text; // xml 결과
